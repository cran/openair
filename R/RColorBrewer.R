...
brewer.pal <- function(n, name) {
  ...
  switch(
    ...
    Dark2 = switch(
      ...
      grDevices::rgb(
        c(27, 217, 117, 231, 102),
        c(158, 95, 112, 41, 166),
        c(119, 2, 179, 138, 30),
        maxColorValue = 255
      ),
      grDevices::rgb(
        c(27, 217, 117, 231, 102, 230),
        c(158, 95, 112, 41, 166, 171),
        c(119, 2, 179, 138, 30, 2),
        maxColorValue = 255
      ),
      grDevices::rgb(
        c(27, 217, 117, 231, 102, 230, 166),
        c(158, 95, 112, 41, 166, 171, 118),
        c(119, 2, 179, 138, 30, 2, 29),
        maxColorValue = 255
      ),
      grDevices::rgb(
        c(27, 217, 117, 231, 102, 230, 166, 102),
